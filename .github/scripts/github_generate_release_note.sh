...
_x64_hash_name="bugium_${_chromium_version}-${_ungoogled_revision}.${_package_revision}_x86_64-macos.dmg.hashes.md"
_arm64_hash_name="bugium_${_chromium_version}-${_ungoogled_revision}.${_package_revision}_arm64-macos.dmg.hashes.md"
